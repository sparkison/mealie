...
from . import (
    ...
    controller_mealplan,
    controller_mealplan_named_plans,
...
# More-specific mealplan prefixes must be registered before the base mealplan router
router.include_router(controller_mealplan_named_plans.router)
